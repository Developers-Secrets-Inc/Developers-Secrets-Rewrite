...
interface PasswordInputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'name'> {
  control?: Control<any>
}

export function PasswordInput({ control: controlProp }: PasswordInputProps) {
